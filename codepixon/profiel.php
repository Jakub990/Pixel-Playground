...
<body>
    ...
    <main>
        ...
        <section class="profiel-blok">
            ...
            <p>Beste 4 op een Rij Streak: 9</p>
        </section>
        ...
        <section class="profiel-blok">
            ...
            <ul>
                ...
                <li>🎯 <strong>Vandaag Hangt Niemand</strong> - Raad een woord in Galgje zonder fouten</li>
                <li>⭐ <strong>Top Tier Gamer</strong> - Speel in totaal meer dan 100 spellen</li>
                <li>🧓 <strong>Old Person</strong> - Account bestaat al 5 jaar</li>
            </ul>
        </section>
    </main>
